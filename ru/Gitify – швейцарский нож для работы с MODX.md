...
Пожалуй, ради этих двух команд Gitify и затевался как проект. Первая позволяет вытащить из базы данных все сущности, описанные в .gitify и сохранить в файлы. build делает обратную операцию — записывает содержимое файлов в базу данных, удаляет не нужные элементы, создает недостающие, управляет конфликтами.
...
=== вот тут самый сок нужно писать ===
